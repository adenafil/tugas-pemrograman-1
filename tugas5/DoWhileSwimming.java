...
1. Yes it Does
2. Gallant has swom for 0 minute & Goofus has swom for 1 minute.
3. yes it does
4. he did dive in first
5. the difference between while and do while are do while is like just to run program before check and vice versa.
6.pre-test loop == while && do while == post-test-loop
