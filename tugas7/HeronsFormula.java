public class HeronsFormula
{
	public static void main( String[] args )
	{
		...
		System.out.println("A triangle with sides 8,15,17 has an area of " + triangleArea(9, 9, 9) );
...
//1.they do the same output
//2. in no function = 50 lines
//in function = 19 lines
//3. it was easier
//4. it was easy by using function 
